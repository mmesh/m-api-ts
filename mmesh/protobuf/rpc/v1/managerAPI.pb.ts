...
export class ManagerAPI {
  ...
  static SendMail(req: MessagingMail.SendMailRequest, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<MessagingMail.SendMailRequest, StatusStatus.StatusResponse>(`/api/v1/mail`, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
  ...
  static DeleteWebhook(req: WebhookWebhook.Webhook, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<WebhookWebhook.Webhook, StatusStatus.StatusResponse>(`/api.ManagerAPI/DeleteWebhook`, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
  ...
  static DeleteLocation(req: LocationLocation.LocationReq, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<LocationLocation.LocationReq, StatusStatus.StatusResponse>(`/api.ManagerAPI/DeleteLocation`, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
  ...
  static DeleteFederation(req: ControllerController.Federation, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<ControllerController.Federation, StatusStatus.StatusResponse>(`/api.ManagerAPI/DeleteFederation`, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
  ...
  static DeleteController(req: ControllerController.Controller, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<ControllerController.Controller, StatusStatus.StatusResponse>(`/api.ManagerAPI/DeleteController`, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
  ...
  static DeleteRouter(req: TopologyRouter.RouterReq, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<TopologyRouter.RouterReq, StatusStatus.StatusResponse>(`/api/v1/locations/${req["locationID"]}/routers/${req["routerID"]}`, {...initReq, method: "DELETE"})
  }
}