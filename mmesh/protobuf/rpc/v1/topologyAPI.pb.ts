...
export class TopologyAPI {
  ...
  static DeleteNetwork(req: TopologyNetwork.NetworkReq, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<TopologyNetwork.NetworkReq, StatusStatus.StatusResponse>(`/api/v1/accounts/${req["accountID"]}/tenants/${req["tenantID"]}/networks/${req["netID"]}`, {...initReq, method: "DELETE"})
  }
  ...
  static DeleteSubnet(req: TopologySubnet.SubnetReq, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<TopologySubnet.SubnetReq, StatusStatus.StatusResponse>(`/api/v1/accounts/${req["accountID"]}/tenants/${req["tenantID"]}/networks/${req["netID"]}/subnets/${req["subnetID"]}`, {...initReq, method: "DELETE"})
  }
  ...
  static DeleteNode(req: TopologyNode.NodeReq, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<TopologyNode.NodeReq, StatusStatus.StatusResponse>(`/api/v1/accounts/${req["accountID"]}/tenants/${req["tenantID"]}/nodes/${req["nodeID"]}`, {...initReq, method: "DELETE"})
  }
  static DeleteNodeGroup(req: TopologyNode.NodeGroupReq, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<TopologyNode.NodeGroupReq, StatusStatus.StatusResponse>(`/api.TopologyAPI/DeleteNodeGroup`, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
