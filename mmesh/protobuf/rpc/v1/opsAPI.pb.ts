...
export class OpsAPI {
  ...
  static DeleteProject(req: OpsProject.ProjectReq, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<OpsProject.ProjectReq, StatusStatus.StatusResponse>(`/api/v1/accounts/${req["accountID"]}/tenants/${req["tenantID"]}/projects/${req["projectID"]}`, {...initReq, method: "DELETE"})
  }
  ...
  static DeleteWorkflow(req: OpsWorkflow.WorkflowReq, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<OpsWorkflow.WorkflowReq, StatusStatus.StatusResponse>(`/api/v1/accounts/${req["accountID"]}/tenants/${req["tenantID"]}/projects/${req["projectID"]}/workflows/${req["workflowID"]}`, {...initReq, method: "DELETE"})
  }
  static ActionWorkflow(req: OpsWorkflow.WorkflowAction, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<OpsWorkflow.WorkflowAction, StatusStatus.StatusResponse>(`/api.OpsAPI/ActionWorkflow`, {...initReq, method: "POST", body: JSON.stringify(req, fm.replacer)})
  }
  ...
  static DeleteTaskLog(req: OpsWorkflow.TaskLogReq, initReq?: fm.InitReq): Promise<StatusStatus.StatusResponse> {
    return fm.fetchReq<OpsWorkflow.TaskLogReq, StatusStatus.StatusResponse>(`/api/v1/accounts/${req["accountID"]}/tenants/${req["tenantID"]}/projects/${req["projectID"]}/workflows/${req["workflowID"]}/tasklogs/${req["taskLogID"]}`, {...initReq, method: "DELETE"})
  }
}